...
void loop() {  
  ...
  RS_gas = (5.0/sensor_volt)-1.0; //Get value of RS in a gas
  ...
  float ppm_log = (log10(ratio)-1.925756)/-0.457647; //Get ppm value in linear scale according to the the ratio value  
